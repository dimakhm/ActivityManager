...
///////////////////////
	...
	public static void AvtivityRergister(User user,Activity activity) throws Exception
	{
		
			activity.prerequisites();
			int capicityLeft=ActivityDataManagment.capicityByActivity(activity.getActivityID());
			if (capicityLeft>=1)
			{
				UserDataManagment.RegisterUserToAvctivity(user, activity.getActivityID());
				ActivityDataManagment.incrementCapicity(activity.getActivityID());
				
		    	 JOptionPane.showMessageDialog(null, "Excellent! registration is successfully done");
				return;
			}
			...
			JOptionPane.showMessageDialog(null, "Sorry, this activity is full");
		  ...
		  Scanner input = new Scanner(System.in);
		    ...
		    case 4: 
		    	int activityIDinput;
		    	  ...
		    	  int type=ActivityDataManagment.getActivityType(activityIDinput);
		    	  switch (type) {
				case 1:
					OtherActivity activity=new OtherActivity(activityIDinput);
			    	  User.AvtivityRergister(user, activity);

					break;
				case 2:
					HighSchoolActivity activity2=new HighSchoolActivity(activityIDinput);
			    	 User.AvtivityRergister(user, activity2);

					break;
				case 3:
					ElementarySchoolActivity activity3=new ElementarySchoolActivity(activityIDinput);
			    	 User.AvtivityRergister(user, activity3);
		    ...
		    case 6:
	            ...
	            JOptionPane.showMessageDialog(null, "Excellent! we sure your opinion will help other");
		    ...
		    case 7:
		    	 ...
		    	 input.nextLine();
		    	 contact.setText(inputf);
		    	 contact.send();
		         JOptionPane.showMessageDialog(null,"Your message sent to city.muni@org.il \n Please check "+user.getEmail()+" for reply soon");
		         break;   
